...
allthesongs$Lyrics <- gsub("Unable to display these lyrics due to licensing restrictions", "NA", allthesongs$Lyrics)

setwd("/Users/danieljauregui-volpe/Desktop/AU Fall 2022/ITEC 724/Final Project")
write.csv(allthesongs, "BillboardHot100_Lyrics_1964-2015.csv", row.names=FALSE)
