...
#VCorpus(VectorSource(tweets),readerControl = readDataframe(tweets,"en",id = ID))
...
corpus <- VCorpus(VectorSource(Lyrics_Decade_1),readerControl = readDataframe(Lyrics_Decade_1,"en",id = ID))
